...
export const INITIAL_DEPARTMENTS: Department[] = [
  {
    ...
    email: 'totonghop.chiengsinh@congan.sonla.gov.vn',
    phone: '0212.385.101',
    memberCount: 4
  },
  {
    ...
    email: 'toanninh.chiengsinh@congan.sonla.gov.vn',
    phone: '0212.385.102',
    memberCount: 4
  },
  {
    ...
    email: 'tocskv.chiengsinh@congan.sonla.gov.vn',
    phone: '0212.385.103',
    memberCount: 6
  },
  {
    ...
    email: 'topctp.chiengsinh@congan.sonla.gov.vn',
    phone: '0212.385.104',
    memberCount: 5
  },
  {
    ...
    email: 'tocstt.chiengsinh@congan.sonla.gov.vn',
    phone: '0212.385.105',
    memberCount: 4
  }
];
...
export const INITIAL_OFFICERS: Officer[] = [
  {
    ...
    email: 'an.nguyen@congan.sonla.gov.vn',
    phone: '0912.345.678',
    departmentId: 'dept-1',
  ...
  },
  {
    ...
    email: 'mai.le@congan.sonla.gov.vn',
    phone: '0983.112.233',
    departmentId: 'dept-1',
    departmentName: 'Tổ Tổng hợp'
  },
  {
    ...
    email: 'tam.lo@congan.sonla.gov.vn',
    phone: '0904.556.778',
    departmentId: 'dept-2',
  ...
  },
  {
    ...
    email: 'son.ha@congan.sonla.gov.vn',
    phone: '0977.889.900',
    departmentId: 'dept-2',
    departmentName: 'Tổ An ninh'
  },
  {
    ...
    email: 'hoang.cam@congan.sonla.gov.vn',
    phone: '0913.224.466',
    departmentId: 'dept-3',
  ...
  },
  {
    ...
    email: 'nam.tong@congan.sonla.gov.vn',
    phone: '0936.778.899',
    departmentId: 'dept-3',
    departmentName: 'Tổ CSKV (Cảnh sát khu vực)'
  },
  {
    ...
    email: 'tuan.tran@congan.sonla.gov.vn',
    phone: '0945.123.987',
    departmentId: 'dept-4',
  ...
  },
  {
    ...
    email: 'duc.quang@congan.sonla.gov.vn',
    phone: '0988.776.554',
    departmentId: 'dept-4',
    departmentName: 'Tổ PCTP (Phòng chống tội phạm)'
  },
  {
    ...
    email: 'hai.vi@congan.sonla.gov.vn',
    phone: '0915.667.889',
    departmentId: 'dept-5',
...
export const INITIAL_TASKS: Task[] = [
  {
    ...
    assigneeEmail: 'mai.le@congan.sonla.gov.vn',
  ...
  },
  {
    ...
    assigneeEmail: 'duc.quang@congan.sonla.gov.vn',
  ...
  },
  {
    ...
    assigneeEmail: 'nam.tong@congan.sonla.gov.vn',
  ...
  },
  {
    ...
    assigneeEmail: 'hai.vi@congan.sonla.gov.vn',
  ...
  },
  {
    ...
    assigneeEmail: 'son.ha@congan.sonla.gov.vn',
  ...
  },
  {
    ...
    assigneeEmail: 'hoang.cam@congan.sonla.gov.vn',
    assignerName: 'Trưởng Công an xã Chiềng Sinh',
  ...
  },
  {
    ...
    assigneeEmail: 'tuan.tran@congan.sonla.gov.vn',
    assignerName: 'Trưởng Công an xã Chiềng Sinh',
  ...
  },
  {
    ...
    assigneeEmail: 'an.nguyen@congan.sonla.gov.vn',
    assignerName: 'Trưởng Công an xã Chiềng Sinh',
...
export const INITIAL_NOTIFICATIONS: NotificationItem[] = [
  {
    ...
    recipientEmail: 'mai.le@congan.sonla.gov.vn',
  ...
  },
  {
    ...
    recipientEmail: 'topctp.chiengsinh@congan.sonla.gov.vn',
    type: 'overdue_warning',
  ...
  },
  {
    ...
    recipientEmail: 'nam.tong@congan.sonla.gov.vn',
    type: 'reminder',
