...
export const TaskModal: React.FC<TaskModalProps> = ({
  ...
  const handleOpenAddOfficer = () => {
    ...
    setOffEmail(currentDeptObj ? currentDeptObj.email : 'canbo.chiengsinh@congan.gov.vn');
  ...
  const handleSaveOfficer = (e: React.FormEvent) => {
    ...
    if (officerToEdit) {
      ...
      const updated: Officer = {
        ...
        email: offEmail.trim() || 'canbo@congan.gov.vn',
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onSave({
      ...
      assigneeEmail: selectedOff ? selectedOff.email : (selectedDept?.email || 'canbo@congan.gov.vn'),
      assignerName,
      startDate,
      dueDate,
      priority,
              ...
              <form onSubmit={handleSaveOfficer} className="p-5 space-y-3.5 text-xs sm:text-sm">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div>
                    ...
                    <input
                      type="email"
                      placeholder="canbo@congan.gov.vn"
                      value={offEmail}
